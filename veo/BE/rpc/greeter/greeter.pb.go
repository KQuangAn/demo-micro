...
const file_greeter_proto_rawDesc = "" +
	"\n" +
	"\rgreeter.proto\x12\agreeter\"\x1d\n" +
	"\aMessage\x12\x12\n" +
	"\x04body\x18\x01 \x01(\tR\x04body29\n" +
	"\aGreeter\x12.\n" +
	"\x04Chat\x12\x10.greeter.Message\x1a\x10.greeter.Message(\x010\x01B\vZ\t./greeterb\x06proto3"
...
var file_greeter_proto_depIdxs = []int32{
	0, // 0: greeter.Greeter.Chat:input_type -> greeter.Message
	0, // 1: greeter.Greeter.Chat:output_type -> greeter.Message
