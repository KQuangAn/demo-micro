...
module "notification-service" {
  ...
  notification_db_name     = var.notification_db_name
  notification_db_username = var.notification_db_username
  notification_db_password = var.notification_db_password
}
